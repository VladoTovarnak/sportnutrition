...
<div class="actions">
	<ul>
		...
		<li><?php
echo $html->link('Posun nahoru v hierarchii', array('action' => 'moveup', $category['Category']['id'])); ?></li>
		<li><?php
echo $html->link('Posun dolů v hierarchii', array('action' => 'movedown', $category['Category']['id'])); ?></li>
		<li><?php
echo $html->link('Přesun do jiného uzlu', array('action' => 'movenode', $category['Category']['id'])); ?></li>
