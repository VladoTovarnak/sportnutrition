	<div id="main">
		...
		<p>Toto jsou naš největší hvědzy, <strong>ideální poměr cena - výkon</strong>. Objednej ještě dnes a <?php echo $delivery_textual ?> můžete <strong>začít kalit ocel</strong>!</p>
		<div class="left">
			<?php
				if (!empty($products)) {
