<div id="footer">
	...
	<div class="copyright">
		...
		<a href="https://www.facebook.com/pages/SportNutrition/230263693680695?fref=ts" target="_blank"><img onerror="this.src='/images/<?php echo REDESIGN_PATH?>placeholder.png';" src="" class="lazy" data-src="/images/<?php echo REDESIGN_PATH ?>logo_facebook.png" width="38" height="38" alt="Facebook" /></a>
		<a href="https://plus.google.com/b/107543305825459915226/107543305825459915226/about?hl=cs" target="_blank"><img onerror="this.src='/images/<?php echo REDESIGN_PATH?>placeholder.png';" src="" class="lazy" data-src="/images/<?php echo REDESIGN_PATH ?>logo_google.png" width="38" height="38" alt="Google+" /></a>
		<a href="http://www.youtube.com/channel/UCheMzjYoHUiq-9I5OH3DdKA" target="_blank"><img onerror="this.src='/images/<?php echo REDESIGN_PATH?>placeholder.png';" class="lazy" src="" data-src="/images/<?php echo REDESIGN_PATH ?>logo_youtube.png" width="38" height="38" alt="YouTube" /></a>
	</div>
