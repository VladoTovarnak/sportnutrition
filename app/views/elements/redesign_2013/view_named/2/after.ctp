...
<div style="float:left;">
	...
	<ul>
		...
		<li>podpora mozkové a srdeční činnosti</li>
		<li>vyšší fyzický výkon</li>
		<li>předchází rychlému nástupu únavy po cvičení</li>
		<li>podopora zotavení po cvičení</li>
		<li>snižování cholesterolu v krvi</li>
