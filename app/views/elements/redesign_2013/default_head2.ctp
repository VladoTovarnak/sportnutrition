...
?>
		...
		if ($this->layout == "redesign_2013/order_process") {
		 ...
		 ?>
		<link rel="stylesheet" href="/css/<?php echo REDESIGN_PATH?><?php echo ($_SERVER['REMOTE_ADDR'] == IMAGE_IP ? 'style000-new.css' : 'style000.min.css?v=1.31')?>" type="text/css" media="screen" />
