		...
		<div class="product card">
			...
			<a class="image_holder" href="/<?php echo $suggested_product['Product']['url']?>">
				<img src="" class="lazy" data-src="/product-images/small/<?php echo $suggested_product['Image']['name']?>" alt="<?php echo $suggested_product['Product']['title']?>" />
			</a>
...
<?php			foreach ($hp_most_sold as $product) { ?>
					<div class="slide product card big" style="z-index: 2; left: 0px; top: 0px;">
						...
						<a class="image_holder" href="/<?php echo $product['Product']['url']?>">
							<img class="lazy" src="" data-src="/product-images/small/<?php echo $product['Image']['name']?>" alt="<?php echo $product['Product']['title']?>"/>
						</a>
...
?>
		...
		<div class="product card">
			<h3><a href="/<?php echo $product['Product']['url']?>"><?php echo $product['Product']['name']?></a></h3>
			<a class="image_holder" href="/<?php echo $product['Product']['url']?>"><img class="lazy" src="" data-src="/product-images/small/<?php echo $product['Image']['name']?>" alt="<?php echo $product['Product']['title']?>" /></a>
